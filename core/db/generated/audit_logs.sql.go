...
func (q *Queries) ListAuditLogsByEntity(ctx context.Context, arg ListAuditLogsByEntityParams) ([]AuditLog, error) {
	rows, err := q.db.QueryContext(ctx, listAuditLogsByEntity, arg.ProjectID, arg.EntityType, arg.EntityID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListAuditLogsByProject(ctx context.Context, arg ListAuditLogsByProjectParams) ([]ListAuditLogsByProjectRow, error) {
	rows, err := q.db.QueryContext(ctx, listAuditLogsByProject, arg.ProjectID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
